    ...
    <section id="services" className="py-24 relative">
      <div className="container mx-auto px-6">
        <div ref={ref} className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          {/* <button className="w-full justify-center m-12 sm:w-auto px-6  py-3 sm:py-4 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full text-white font-semibold hover:shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 transform hover:scale-105 glow-button">
              <a href='https://wa.me/917652090512'>Ready to Transform Your Business? Let's Talk Solutions.</a>
          </button> */}
          {/* <a
  href="https://wa.me/917652090512"
  className=" sm:w-auto block text-center px-6 py-3 sm:py-4 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full text-white font-semibold hover:shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 transform hover:scale-105 glow-button mx-auto my-12"
>
